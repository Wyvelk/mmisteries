...
<section class='avancee'>
    <div class='pfp'> </div>
    <div>
        <p class='resultat'>Equipe
        <p class='teamname'>Nom de la team</p>, voici vos résultats actuels</p>
    </div>

    <div>
        <p class=timer> Temps restant: 3j, 9h, 34min et 20s</p>
    </div>
    ...
    <div class='bandeau'>
        ...
        <div>
            <div>dernier accomplissement</div>
